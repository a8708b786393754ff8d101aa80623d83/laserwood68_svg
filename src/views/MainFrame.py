...
class MainFrame(ttk.Frame):
    ...
    def frame(self):
        label_num_frame = ttk.Label(self.root, text='Numero frame').grid(row=2)
    ...
    def font(self):
        label_font = ttk.Label(self.root, text='Font').grid(row=3)
        self.entry_font = ttk.Entry(self.root, textvariable=self.font_)

        self.entry_font.grid(row=3, column=1)

    def taille(self):
        label_taille = ttk.Label(self.root, text='Taille').grid(row=4)
    ...
    def reset_button(self, funct_callback):
        self.button_reset = ttk.Button(
            self.root, text='RESET', command=funct_callback).grid()
